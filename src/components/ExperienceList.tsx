...
const experiences: ExperienceData[] = [
  {
    title: "IBM India Systems Development Lab (ISDL)",
    role: "Software Engineering Mentee",
    dates: "Jan 2025 - Mar 2025",
    location: "Bangalore, Karnataka",
    src: "/project-image/ibm.png",
    imageFit: "contain",
    description: `
      Analyzed enterprise-grade software workflows across 3+ modules at IBM ISDL, gaining exposure to large-scale system design and deployment practices
    ...
    metrics: [
      { label: "Modules Analyzed", value: "3+" },
      { label: "False Positive Reduction", value: "15-20%" },
      { label: "APIs Built", value: "5+" },
      { label: "Term", value: "Jan-Mar" },
    ],
  },
  {
    title: "Connect Infosystems",
    role: "Web Developer Intern",
    dates: "Jun 2024 - Jul 2024",
    location: "Chennai, Tamil Nadu",
    src: "/project-image/connect_infosystems.png",
    imageFit: "contain",
    description: `
