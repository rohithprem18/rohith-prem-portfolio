...
const socialProfiles: Record<string, SocialProfile> = {
  GitHub: {
    name: "Rohith Prem S",
    handle: "rohithprem18",
    avatar: "https://github.com/rohithprem18.png",
    bio: "Final year CS student • Full-stack developer",
  ...
  LinkedIn: {
    name: "Rohith Prem S",
    handle: "in/rohithprem91",
    avatar: "https://github.com/rohithprem18.png",
    banner: darkBannerImage,
    bio: "Final year CS student • Full-stack developer",
    location: "Saveetha Engineering College, Chennai, India",
    stats: [],
  },
  Discord: {
    name: "Rohith Prem S",
    handle: "ft_thor",
    avatar: "/avatar.png",
    bio: "Building, breaking, and shipping things.",
    location: "",
    stats: [],
  },
};
