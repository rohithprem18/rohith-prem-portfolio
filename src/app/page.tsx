    ...
    <div className="min-h-screen w-full bg-white dark:bg-black relative overflow-x-hidden transition-colors duration-300">
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <div className="flex flex-col justify-center pt-8">
              ...
              <p className="text-[13px] sm:text-[14px] text-zinc-500 dark:text-zinc-400">Final Year Student, Saveetha Engineering College</p>
            </div>
          </div>
      ...
      <div className="ml-0 mr-0 md:ml-[30%] md:mr-[30%] pt-[calc(22vh+112px)] pb-0 px-4 flex flex-col z-10 relative min-h-screen">
        <p className="text-[14px] sm:text-[15px] text-zinc-600 dark:text-zinc-300 leading-relaxed mt-4">
          Full-stack developer / final-year CS student. I love building, breaking, and shipping things.
        </p>

        <ul className="text-[14px] sm:text-[15px] text-zinc-600 dark:text-zinc-300 leading-relaxed mt-4 pl-4">
          <li className="flex gap-1.5"><span>•</span><span>Full-stack engineering, applied ML, and obsessing over 2px of padding excite me more than they probably should.</span></li>
          <li className="flex gap-1.5"><span>•</span><span>I believe actions speak louder than words, so my commit history does most of the talking for me.</span></li>
          <li className="flex gap-1.5"><span>•</span><span>Shipped 5 full-stack products and solved 300+ DSA problems on LeetCode, mostly by refusing to sleep.</span></li>
        </ul>
        ...
        <div id="contact" className="mt-6 scroll-mt-24">
          ...
          <div className="flex flex-wrap gap-1.5">
            {[
              { name: 'GitHub', href: 'https://github.com/rohithprem18', icon: <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" stroke="currentColor" strokeWidth="2" fill="none"></path> },
              { name: 'LinkedIn', href: 'https://www.linkedin.com/in/rohithprem91', icon: <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2zM4 2a2 2 0 1 1-2 2 2 2 0 0 1 2-2z" stroke="currentColor" strokeWidth="2" fill="none"></path> },
            ...
            <a href="/Rohith_Prem_S_Resume.pdf" target="_blank" rel="noopener noreferrer">
              <SoftPillButton
                as="span"
                variant="secondary"
                className="px-3 py-1.5 !text-[12px]"
